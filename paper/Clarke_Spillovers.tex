...
\end{assumption}
where for notational simplicity $D$ and $R$ are used instead of the more 
extensive $D(i,1)$ and $R(i,1)$.
...
For those individuals $i\notin J$ (ie for whom SUTVA does not hold), the assumption
is violated due to observable spillovers $R^k$
\end{assumption}
