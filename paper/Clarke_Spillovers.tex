...
use $d$ to correctly map $X(i,t)$ into $R(i,t)$. Given the
above we can now estimate (\ref{Seqn:cDD}), and form consistent estimates $\hat\beta$ 
and $\hat\alpha$ using OLS.
...
the control area, providing additonal evidence in favour of spillovers.
